...
with open('/home/devendra/Desktop/BisQue_Modules/EBSDSR_Module/EBSDSR/src/config_nonbisque.yaml') as f:
...
class Test:
    def __init__(self):
        ...
        self.dir = f'/home/devendra/Desktop/BisQue_Modules/EBSDSR_Module/EBSDSR/src'
    ...
    def inference(self, lr):
        ...
        sr = sr.cpu().numpy()
        np.save(f'{self.save_path}/Ti64_SR.npy', sr)       
    ...
    def pipelinerunner(self, filetype):
        ...
        os.system("/home/devendra/Desktop/BisQue_Modules/EBSDSR_Module/EBSDSR/src/DREAM3D-6.5.141-Linux-x86_64/bin/PipelineRunner -p /home/devendra/Desktop/BisQue_Modules/EBSDSR_Module/EBSDSR/src/pipeline.json")
