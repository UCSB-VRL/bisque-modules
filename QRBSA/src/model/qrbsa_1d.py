...
class QRBSA_1D(nn.Module):
    def __init__(self, args):
        ...
        m_head = [conv2d(n_colors, n_feats,  kernel_size = kernel_size, stride = 1, padding=kernel_size//2)]
        ...
        m_tail = [
            ...
            conv2d(n_feats, n_colors,  kernel_size = kernel_size, stride = 1, padding=kernel_size //2)
        ]
