...
class Test:
    ...
    def inference(self, lr):
        ...
        sr = sr.cpu().numpy()
        np.save(f'{self.dir}/{self.save_path}/output_SR.npy', sr)
...
def run_module(input_path_dict, output_folder_path):  
    ...
    lr_data_path = input_path_dict['Input File']
    ...
    output_img_path_1 = f'/module/src/data/output_SR.npy'
    output_img_path_2 = f'/module/src/data/output_SR.dream3d'
    output_img_path_3 = f'/module/src/data/output_LR.dream3d'
    ...
    shutil.copy2(f'{output_img_path_1}', os.path.join('/outputs', 'output_SR.npy'))    
    shutil.copy2(f'{output_img_path_2}', os.path.join('/outputs', 'output_SR.dream3d')) 
    shutil.copy2(f'{output_img_path_3}', os.path.join('/outputs', 'output_LR.dream3d')) 
    #shutil.copy2(f'{output_img_path_4}', os.path.join('/outputs', 'Ti64_SR.png'))
 
    output_paths_dict = {}   
 
    output_paths_dict['Output Arr'] = os.path.join('/outputs', 'output_SR.npy')
    output_paths_dict['Output File'] = os.path.join('/outputs', 'output_SR.dream3d')
    output_paths_dict['Input LR File'] = os.path.join('/outputs', 'output_LR.dream3d')
...
if __name__ =='__main__':
    ...
    input_path_dict['Input File'] = os.path.join(curr_dir, 'Ti64_3D_LR.npy') 
    ...
    output_img_path_2 = output_paths_dict['Output File']
    output_img_path_3 = output_paths_dict['Input LR File']
